...
mermaid: true
image:
  path: /images/2024-04-15/云平台-microk8s（二）：高可用部署/云平台-microk8s（二）：高可用部署-00.jpg
...
![尚未开启高可用](/images/2024-04-15/云平台-microk8s（二）：高可用部署/云平台-microk8s（二）：高可用部署-01.png)
...
![尚未开启高可用](/images/2024-04-15/云平台-microk8s（二）：高可用部署/云平台-microk8s（二）：高可用部署-02.png)
...
![开启高可用](/images/2024-04-15/云平台-microk8s（二）：高可用部署/云平台-microk8s（二）：高可用部署-03.png)
...
![standby节点](/images/2024-04-15/云平台-microk8s（二）：高可用部署/云平台-microk8s（二）：高可用部署-04.png)
